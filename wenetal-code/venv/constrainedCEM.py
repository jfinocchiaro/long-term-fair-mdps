...
class ConstrainedCEM:
    def __init__(self, env, policy, n_samples, h, rho, nl, sess, equal_opp_thres, log_folder):
        ...
        self.initialize_v() # initialize theta for the policy distribution pi_theta
        self._initialize_DP() # computes all possible states that may be visited, which is saved in self.key_states.
    ...
    def evaluate_policy(self, fairness_constraint=None):
        ...
        :return: [g_objective, h_objective] for self.policy #Jessie: unclear to me what these are 
        """

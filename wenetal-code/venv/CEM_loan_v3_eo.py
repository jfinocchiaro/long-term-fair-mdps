...
log_folder = base_folder + "OptEO_" + file_name_base

if not os.path.exists(log_folder):
    os.makedirs(log_folder)

root_folder = base_folder + "venv"
copy2(root_folder + '/CEM_loan_v3_eo.py', log_folder)
...
# agent.train_optimistic_DP()
agent.train_optimistic_EO(equal_opp_thres)
